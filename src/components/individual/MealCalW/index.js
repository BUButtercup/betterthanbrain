...
const MealCalW = ({ setExpanded, expanded }) => {
    ...
    const openPanel = (e) => {
        ...
        const targetMeal = e.target.id.split('-')[1];
    ...
    return (
        <Grid container id='meal-cal-box' columns={{ xs: 9, md: 5 }}>
            <Grid item>
                                ...
                                <h2>{title.title}</h2>
                                {
                                    ...
                                    >
                                        ...
                                        <div className='meal-box-inpt'>
                                            <Tooltip title='Click to drag & drop'>
            ...
            <MealSearchModal day={dayMealChoice} open={open} close={handleClose} setSearchInpt={setSearchInpt} searchInpt={searchInpt} />
        </Grid>
    )
}
